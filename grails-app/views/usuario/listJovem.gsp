...
<html>
    ...
    <body>
        <div id="pageBody">
			...
			<h3>Procurar Jovem</h3>
			<richui:autoComplete name="pegarUsuarioJovem" action="${createLinkTo('dir': 'usuario/pegarUsuariosJovens')}" onItemSelect="document.location.href = \'${createLinkTo(dir: 'usuario/show')}/\' + id;" />
			<br />
