    ...
    <body>
		<div id="carrossel">
			<richui:carousel direction="vertical" itemsStyle="height: 450px;">
				...
				<g:if test="${session.user}">
						<richui:carouselItem> <g:link controller="usuario" action="aniversarios"><img src="${resource(dir:'images',file:'aniversarios.png')}" /></g:link> <br/></richui:carouselItem>
						<richui:carouselItem> <g:link controller="enquete" action="list"><img src="${resource(dir:'images',file:'enquetes.png')}" /></g:link> <br/></richui:carouselItem>
				</g:if>
