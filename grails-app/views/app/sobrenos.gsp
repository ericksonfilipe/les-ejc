<html>
  ...
  <body>
    <div class="pageBody">
		...
		<br>
		<p align="justify">
			A Paróquia de São Cristóvão, da Diocese de Campina Grande, Paraíba, realiza o Encontro de Jovens com Cristo (EJC) desde 2000. O encontro acontece durante um final de semana e provê ao jovem um contato pessoal com Jesus, de uma forma evangelizadora, alegre e descontraída.
			<br><br>
		...
		<p align="justify">
			...
			<br><br>
			Mais informações no site: <a href="http://www.paroquiadesaocristovaocg.com" target="_blank">www.paroquiadesaocristovaocg.com</a>.
		</p>
    </div>
  </body>
</html>